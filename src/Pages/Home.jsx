      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[5%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div
              className="w-full lg:w-1/2 order-2 mt-8 lg:mt-0 flex items-center justify-center"
              data-aos="fade-left"
              data-aos-delay="600"
            >
              <div className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] 2xl:h-[600px] max-w-[600px]">
                <SplineViewer />
              </div>
            </div>
          </div>
