...
const WORDS = ["Backend Developer", "Junior Developer","Fullstack Developer","Programming Enthusiast", "Tech Explorer"];
const TECH_STACK = ["React", "Next", "Node.js", "Prisma", "Postgresql", "MongoDB"];
const SOCIAL_LINKS = [
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Self-dependent, enthusiastic, and responsible developer skilled in mobile and web apps, seeking opportunities to apply creativity, knowledge, and skills.
                </p>
